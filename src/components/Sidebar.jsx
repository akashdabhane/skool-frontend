...
function Sidebar() {
  ...
  return (
    <div className={`${showBar ? "w-[22rem]" : "w-20"}`}>
      <div className={`${showBar ? "w-[18rem]" : "w-20"} bg-gray-800 text-white hidden md:flex flex-col items-center py-4 fixed h-full `} onMouseEnter={toggleBar} onMouseLeave={toggleBar}>
