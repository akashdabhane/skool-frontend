  ...
  return (
    <div className="flex items-center justify-between bg-white shadow p-4 sticky top-0 right-0 z-10">
      ...
      <div className="flex items-center space-x-4">
        <GoPlus className="p-2 w-10 h-10 text-2xl text-center align-middle rounded-full bg-gray-200 hover:bg-gray-300 cursor-pointer" onClick={() => setShowJoinClass(true)} />
